...
export const extensionSchemas = {
  ...
  RideRequest: {
    ...
    properties: {
      ...
      legs: {
        type: "array",
        items: { $ref: "#/components/schemas/RideRequestLeg" },
      },
    },
  },
  RideRequestLeg: {
    type: "object",
    description: "Intermediate segment or waypoint in a multi-leg itinerary.",
    properties: {
      id: { type: "string", format: "uuid" },
      ride_request_id: { type: "string", format: "uuid" },
      sequence_order: { type: "integer", example: 1 },
      pickup_address: { type: "string", example: "Bole International Airport, Addis Ababa" },
      pickup_latitude: { type: "number", nullable: true },
      pickup_longitude: { type: "number", nullable: true },
      dropoff_address: { type: "string", example: "Ethiopian Skylight Hotel, Airport Rd" },
      dropoff_latitude: { type: "number", nullable: true },
      dropoff_longitude: { type: "number", nullable: true },
      scheduled_at: { type: "string", format: "date-time", nullable: true },
      estimated_distance_km: { type: "number", nullable: true },
      actual_distance_km: { type: "number", nullable: true },
      planned_wait_minutes: { type: "integer", example: 30 },
      actual_wait_minutes: { type: "integer", example: 25 },
      stop_purpose: { type: "string", nullable: true, example: "VIP Delegation Check-in" },
      status: { $ref: "#/components/schemas/RideRequestStatus" },
      started_at: { type: "string", format: "date-time", nullable: true },
      completed_at: { type: "string", format: "date-time", nullable: true },
    },
