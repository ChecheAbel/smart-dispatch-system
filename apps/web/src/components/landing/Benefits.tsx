...
const benefits = [
  {
    title: "100% Localized for Ethiopia",
    description: "Built specifically for the Ethiopian market. Automatically generate ETB corporate invoices, manage local compliance, and operate without friction.",
    icon: Map,
  },
  {
    title: "Enterprise-Grade Security",
    description: "Designed for large transport agencies. We guarantee data privacy, SLA-backed uptime, and secure role-based access for your entire organization.",
    icon: ShieldCheck,
  },
  {
    title: "Data-Driven Insights",
    description: "Make smarter decisions. Track fuel costs, driver performance, and fleet utilization in real-time to drastically reduce operational waste.",
    icon: BarChart3,
  },
];
    ...
    <section id="benefits" className="bg-slate-50 py-20 sm:py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-16 sm:mb-24">
          ...
          >
            <p className="text-[#C9B87A] font-bold text-[10px] sm:text-xs tracking-[0.25em] uppercase mb-4 drop-shadow-sm">Why Choose Us</p>
            ...
            <p className="mt-5 text-slate-500 text-base sm:text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed px-2 font-light">
              We focus on what matters to your business: localization, security, and profitability.
            </p>
          </motion.div>
        </div>
          ...
          {benefits.map((benefit, i) => (
            ...
            >
              <div className="h-16 w-16 rounded-2xl bg-[#C9B87A]/10 border border-[#C9B87A]/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-[0_0_15px_-3px_rgba(201,184,122,0.3)] relative bg-white">
                <benefit.icon className="h-8 w-8 text-[#C9B87A]" strokeWidth={1.5} />
              </div>
