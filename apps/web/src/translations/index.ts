...
import type {
  ...
  AdminNotificationsPushMessages,
  AdminNotificationsSendMessages,
  AdminRolesMessages,
  AdminUsersMessages,
  AdminUserRegistrationsMessages,
  AdminDriversMessages,
  AdminRideRequestsMessages,
  AdminDispatchMessages,
...
export function getAdminDriversMessages(locale: SupportedLocale): AdminDriversMessages {
  return getTranslations(locale).adminDrivers;
}
...
export function getAdminDispatchMessages(locale: SupportedLocale): AdminDispatchMessages {
  return getTranslations(locale).adminDispatch;
}
...
export function getAdminNotificationsPushMessages(
  locale: SupportedLocale,
): AdminNotificationsPushMessages {
  return getTranslations(locale).adminNotificationsPush;
}

export function getAdminNotificationsSendMessages(
  locale: SupportedLocale,
): AdminNotificationsSendMessages {
  return getTranslations(locale).adminNotificationsSend;
}
...
export function getAdminBrandingSettingsMessages(
  locale: SupportedLocale,
): AdminBrandingSettingsMessages {
...
export function getCustomerAuthMessages(locale: SupportedLocale): CustomerAuthMessages {
  return getTranslations(locale).customerAuth;
}
